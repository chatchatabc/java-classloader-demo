...
/**
 * Custom ClassLoader to load the classes.
 */
public class CCLoader extends ClassLoader {
     ...
     *
     * @param name Fully Classified name of the class, for example, com.chatchatabc.Foo
     */
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("com.chatchatabc.jar3")) {
